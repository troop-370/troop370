<script lang="ts">
  ...
  import type { LayoutData } from '../../routes/(admin)/poptart/$types';
  ...
  <div class="current-profile">
    ...
    {#if !hideButtons}
      <div class="button-row">
        <Button
          href="/poptart/settings/users"
          on:click={(e) => {
            e.preventDefault();
            goto(`/poptart/settings/users/${data.session.adminUser?.id}`);
            flyoutOpen = false;
          }}
        >
