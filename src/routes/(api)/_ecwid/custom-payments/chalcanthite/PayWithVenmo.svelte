<script lang="ts">
  ...
  export let venmoLinkUsed = false;
  let interval: number;
...
<noscript>
  JavaScript is required for Venmo payment, but you have disabled JavaScript. Please enable
  JavaScript to pay with Venmo.
</noscript>
...
<style>
  :global(.checkout--pay-with-venmo) {
    ...
    background-color: hsl(198, 100%, 44%) !important;
    min-height: 36px !important;
    border-radius: var(--radius) !important;
    border: none;
  }

  :global(.checkout--pay-with-venmo:hover) {
    background-color: hsl(198, 100%, 48%) !important;
  }

  :global(.checkout--pay-with-venmo:active) {
    background-color: hsl(198, 100%, 40%) !important;
  }
